...
from criteria import cur_loss, w_norm
...
class Coach:
    def __init__(self, opts):
        ...
        if self.opts.id_lambda > 0:
            self.id_loss = cur_loss.IDLoss(self.opts).to(self.device).eval()
    ...
    def calc_loss(self, x, x_hat,ref_img,w):
        ...
        if self.opts.l2w_lambda > 0:
            # mean keeps magnitude aligned with other losses
