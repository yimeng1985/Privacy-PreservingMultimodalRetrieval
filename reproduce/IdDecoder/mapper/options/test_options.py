...
class TestOptions:
    ...
    def initialize(self):
        ...
        # for visualization: original images corresponding to embeddings
        self.parser.add_argument('--img_root', default=None, type=str, help='Root directory of original images that match the embedding files')
